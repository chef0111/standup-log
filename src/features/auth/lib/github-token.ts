...
export async function persistGitHubProviderToken(token: string | null | undefined): Promise<void> {
  if (!token) {
    return;
  }
 ...
 */
export async function resolveGitHubAccessToken(session: Session | null): Promise<string | null> {
