...
Check if latest is beta: [https://exp.host/--/api/v2/versions](https://exp.host/--/api/v2/versions) (look for `-preview` in `expoVersion`)
...
- Review release notes for the target SDK version at [https://expo.dev/changelog](https://expo.dev/changelog)
