...
- [ ] **Phase 0** — Project spine & contracts (all gates)
- [ ] **Phase 1** — Identity, session, account lifecycle (all gates)
- [ ] **Phase 2** — GitHub access: repo discovery & explicit selection (all gates)
...
## Phase 0 — Project spine & contracts
...
## Phase 1 — Identity, session, account lifecycle
...
## Phase 2 — GitHub access: repo discovery & explicit selection
